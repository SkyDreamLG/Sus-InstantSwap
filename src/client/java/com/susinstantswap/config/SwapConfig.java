    ...
    public static void load() {
        ...
        if (file.exists()) {
            try (Reader reader = new FileReader(file)) {
                ...
                LOGGER.info("[SusInstantSwap] 配置已加载: longPressMode={}, holdThresholdMs={}, soundEnabled={}, mouseReposition={}, debug={}",
                        INSTANCE.longPressMode, INSTANCE.holdThresholdMs, INSTANCE.soundEnabled, INSTANCE.mouseReposition, INSTANCE.debug);
            } catch (Exception e) {
