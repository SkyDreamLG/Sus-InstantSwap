...
/**
 * Forge 26.1 native config screen using vanilla widgets only.
 * MC 26.1: render → extractRenderState, renderBackground → extractBackground,
 * drawCenteredString → centeredText, GuiGraphics → GuiGraphicsExtractor.
 */
public class ForgeConfigScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor gui, int mouseX, int mouseY, float partialTicks) {
        ...
        gui.centeredText(this.font, this.title, this.width / 2, 15, 0xFFFFFF);
