...
/**
 * Su's Instant Swap (探囊取物) — Forge 1.21.1 主类。
 * 纯客户端模组。
 *
 * 事件总线说明：
...
public class SusInstantSwapMod {
    ...
    public SusInstantSwapMod() {
        LOGGER.info("[SusInstantSwap] v1.2.0-Forge1.21.1 — loading started");
        ...
        LOGGER.info("[SusInstantSwap] v1.2.0-Forge1.21.1 — loaded");
    }
